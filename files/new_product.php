...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO products (user_id, category_id, name, description, price) VALUES (?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("iissd", $user["id"], $category_id, $name, $description, $price);
    $stmt->execute();
...
<div class="container mx-auto mt-10">
    ...
    <form action="" method="POST" class="bg-white p-4 shadow rounded">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="category_name" name="category_name" class="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
